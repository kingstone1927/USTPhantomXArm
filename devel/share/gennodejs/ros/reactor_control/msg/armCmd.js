...
class armCmd {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    if (obj.accel.length !== 6) {
      throw new Error('Unable to serialize array field accel - length must be 6')
    }
    // Serialize message field [accel]
    bufferOffset = _arraySerializer.float32(obj.accel, buffer, bufferOffset, 6);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.accel = _arrayDeserializer.float32(buffer, bufferOffset, 6)
  ...
  static Resolve(msg) {
    ...
    if (msg.accel !== undefined) {
      ...
      resolved.accel = new Array(6).fill(0)
    }
