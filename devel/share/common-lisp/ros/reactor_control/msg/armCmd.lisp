...
(cl:defmethod cl:initialize-instance :after ((m <armCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'armCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name reactor_control-msg:<armCmd> is deprecated: use reactor_control-msg:armCmd instead.")))
...
(cl:defmethod accel-val ((m <armCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reactor_control-msg:accel-val is deprecated.  Use reactor_control-msg:accel instead.")
  (accel m))
...
(cl:defmethod msg_ctr-val ((m <armCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader reactor_control-msg:msg_ctr-val is deprecated.  Use reactor_control-msg:msg_ctr instead.")
  (msg_ctr m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <armCmd>) istream)
  ...
  (cl:setf (cl:slot-value msg 'accel) (cl:make-array 6))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<armCmd>)))
  ...
  (cl:format cl:nil "float32[6] current #amp~%float32[6] accel #deg/s^2~%float32[6] vel #deg/s~%float32[6] angle #deg~%uint32 msg_ctr  # count number of messages to detect missed msgs~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'armCmd)))
  "Returns full string definition for message of type 'armCmd"
  (cl:format cl:nil "float32[6] current #amp~%float32[6] accel #deg/s^2~%float32[6] vel #deg/s~%float32[6] angle #deg~%uint32 msg_ctr  # count number of messages to detect missed msgs~%~%~%"))
